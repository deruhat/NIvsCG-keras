...
## References
- W. Quan, K. Wang, D. M. Yan and X. Zhang, "[Distinguishing Between Natural and Computer-Generated Images Using Convolutional Neural Networks](https://github.com/weizequan/NIvsCG)," in IEEE Transactions on Information Forensics and Security, vol. 13, no. 11, pp. 2772-2787, Nov. 2018.
- Weize Quan, Dong-Ming Yan, Jianwei Guo, Weiliang Meng, and Xiaopeng Zhang. 2016. [Maximal Poisson-disk Sampling via Sampling Radius Optimization](https://github.com/weizequan/NIvsCG/tree/master/utils). In SIGGRAPH ASIA 2016 Posters (SA '16). ACM, New York, NY, USA, , Article 22 , 2 pages.
